...
BEGIN
  ...
  IF NOT func_found THEN
    ...
    RAISE NOTICE 'The warning may be from a temporary schema (pg_temp_72) which cannot be modified.';
...
-- ============================================
-- 3단계: 모든 함수에서 search_path 확인 (선택사항)
-- ============================================
