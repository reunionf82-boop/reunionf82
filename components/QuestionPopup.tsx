...
export default function QuestionPopup({ isOpen, onClose, menuTitle, subtitles, onQuestionSubmit }: QuestionPopupProps) {
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              <textarea
                ...
                className="question-textarea-custom w-full px-3.5 py-2.5 border border-gray-300 focus:ring-2 focus:ring-pink-500 focus:border-transparent focus:outline-none resize-none"
                style={{
